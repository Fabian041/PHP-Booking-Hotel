...
$payments = query("SELECT p.id,u.username,h.nama,p.nama_bank,p.bukti_bayar,p.jumlah_bayar FROM tb_paymentapproval p INNER JOIN user u ON p.user_id = u.id INNER JOIN tb_hotel h ON p.hotel_id = h.id")
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-link" href="#">Payment Check</a>
    ...
    <section class="hotel">
        <div class="container">
            <div class="row mt-5">
                <div class="col-md-12">
                    <h4>Payment Checking and Approval</h4>
                    <p class="sub">You are allowed to approve or reject payment</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <?php foreach($payments as $payment) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a type="button" class="btn btn-success" href="approved.php?id=<?= $payment["id"] ?>" >Approve</a>  
                                </td>
                                <td class="text-center">
                                    <a type="button" class="btn btn-danger" href="rejected.php?id=<?= $payment["id"] ?>" >reject</a>
                                </td>
                            </tr>
                        <?php $i++; ?>
                        <?php endforeach; ?>
