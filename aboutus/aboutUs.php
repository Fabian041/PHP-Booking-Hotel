    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2 class="us">About Me</h2>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-6">
                <div class="card mb-3 left1" style="max-width: 540px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                        <img src="../sourceImg/fab.jpg" class="card-img" alt="...">
                        </div>
                        <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Mitsal Fabian Nadhiem</h5>
        ...
        <div class="footer">
            ...
            <div class="row">
                <div class="col-md-6 offset-md-4">
                    <p class="pfooter mt-5">Copyright 2020 - D3TK-43-01 - kelompok4</p>
                </div>
            </div>
        </div>
    </div>
